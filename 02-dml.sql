...
/*ALTER TABLE segueix ADD CONSTRAINT segueix_ID_criteri_fk;
ALTER TABLE segueix ADD CONSTRAINT segueix_codi_avaluacio_fk;
ALTER TABLE assignacio ADD CONSTRAINT assignacio_DNI_alumne_fk;
ALTER TABLE assignacio ADD CONSTRAINT assignacio_CIFNIF_empresa_fk;
ALTER TABLE avaluacio ADD CONSTRAINT avaluacio_DNI_alumne_fk;*/
...
INSERT INTO alumne (DNI, nom_cognoms, email, telefon, IDALU, NASS, municipi, CP, promocio, cicle_matricula, actiu, ISO, PAX, RA2_IPO, tecnologies ) VALUES
('89908640F', 'Lucia Torres Garcia','2526_lucia.torres@mail.com', '+34666222333', 12345678956789123456789, 386608768204, 'Hospitalet de Llobregat', '08902','PROM20252026','CFGMSMX', true, false, true, true,'Seguretat Informatica' );
INSERT INTO alumne (DNI, nom_cognoms, email, telefon, IDALU, NASS, municipi, CP, promocio, cicle_matricula, actiu, ISO, PAX, RA2_IPO, tecnologies ) VALUES
...
INSERT INTO alumne (DNI, nom_cognoms, email, telefon, IDALU, NASS, municipi, CP, promocio, cicle_matricula, actiu, ISO, PAX, RA2_IPO, tecnologies ) VALUES
('27849214L', 'Daniel Fernandez Lopez', '2526_daniel.fernandez@gmail.com', '+34666222444',12345678911234567890123, 386608768205, 'Hospitalet de Llobregat', '08902','PROM20252026','CFGMSMX', true, false, true, true,'Seguretat Informatica' );
INSERT INTO alumne (DNI, nom_cognoms, email, telefon, IDALU, NASS, municipi, CP, promocio, cicle_matricula, actiu, ISO, PAX, RA2_IPO, tecnologies ) VALUES
('07739758M', 'Carlos Lopez Fernandez','2526_carlos.lopez@gmail.com','+34666555444',12345678956789123456789, 469580014174, 'Barcelona', '08005','PROM20252026','CFGMSMX', true, true, true, false,'Seguretat Informatica' );
INSERT INTO alumne (DNI, nom_cognoms, email, telefon, IDALU, NASS, municipi, CP, promocio, cicle_matricula, actiu, ISO, PAX, RA2_IPO, tecnologies ) VALUES
...
INSERT INTO alumne (DNI, nom_cognoms, email, telefon, IDALU, NASS, municipi, CP, promocio, cicle_matricula, actiu, ISO, PAX, RA2_IPO, tecnologies ) VALUES
('36537125S', 'Laura Martinez Gomez','2526_laura.martinez@gmail.com', '+34666555777',12345678956789123456789, 417709712797, 'Barcelona', '08002','PROM20252026','CFGMSMX', true, false, true, true,'Linux, Cisco, BD' );

/* Insertar dades d'empresa */

INSERT INTO empresa (CIF/NIF, nom, email, telf, ubicacio, sector, DUAL_intensiva, DUAL_general) VALUES
...
INSERT INTO cv (codicv , DNI_alumne , data_creacio, data_actualitzacio, enllaç , estat , resum ) VALUES 
(5593721731, '55972173V', '2024-02-20', '2024-06-12', 'http://cvserver.com/cv/2', 'Actiu', 'CV Albert Ruiz Pla amb experiència en SAP i bases de dades MySQL i PSQL.');
INSERT INTO cv (codicv , DNI_alumne , data_creacio, data_actualitzacio, enllaç , estat , resum ) VALUES 
...
INSERT INTO cv (codicv , DNI_alumne , data_creacio, data_actualitzacio, enllaç , estat , resum ) VALUES 
(4567890121, '45678912K', '2024-03-12', '2024-06-28', 'http://cvserver.com/cv/15', 'Inactiu', 'CV Daniel Fernandez Morales amb experiència en seguretat informàtica.');
INSERT INTO cv (codicv , DNI_alumne , data_creacio, data_actualitzacio, enllaç , estat , resum ) VALUES 
(1234567811,'Ana Gomez Ruiz', '2024-02-08', '2024-06-15', 'http://cvserver.com/cv/16', 'Actiu', 'CV Ana Gomez Ruiz amb experiència en Windows Server.');
INSERT INTO cv (codicv , DNI_alumne , data_creacio, data_actualitzacio, enllaç , estat , resum ) VALUES 
(1234567812,'Ana Gomez Ruiz', '2024-02-08', '2024-06-15', 'http://cvserver.com/cv/16', 'Actiu', 'CV Ana Gomez Ruiz amb experiència en Windows Server.');
INSERT INTO cv (codicv , DNI_alumne , data_creacio, data_actualitzacio, enllaç , estat , resum ) VALUES 
...
INSERT INTO criteri (id_criteri, descripcio) VALUES 
(1, 'Actitut');
INSERT INTO criteri (id_criteri, descripcio) VALUES 
(2, 'Autonomia');
INSERT INTO criteri (id_criteri, descripcio) VALUES 
...
INSERT INTO avaluacio (codi_avaluacio, DNI_alumne, nota_global, observacions) VALUES
(1016, '87654321C', 7.6, 'Falta saber conceptes teorics.');
/* Insertar segueix */
--1r avaluacio
INSERT INTO segueix (ID_criteri, codi_avaluacio, puntuacio) VALUES
(1, 1001, 9);
INSERT INTO segueix (ID_criteri, codi_avaluacio, puntuacio) VALUES
(2, 1001, 8);
INSERT INTO segueix (ID_criteri, codi_avaluacio, puntuacio) VALUES
...
INSERT INTO enviament (codicv, CIFNIF_empresa, data_contacte, data_resposta, data_entrevista, estat, notes) VALUES
(5593721731, 'H10598357', '2024-04-04', '2024-04-08', '2024-04-13', 'En procés', 'Esperant resposta.');
INSERT INTO enviament (codicv, CIFNIF_empresa, data_contacte, data_resposta, data_entrevista, estat, notes) VALUES
(5593721731, 'S0998199D', '2024-04-05', '2024-04-09', '2024-04-14', 'Rebutjat', 'Perfil no adequat.');
INSERT INTO enviament (codicv, CIFNIF_empresa, data_contacte, data_resposta, data_entrevista, estat, notes) VALUES
(5593721731, 'S0998199D', '2024-04-06', '2024-04-10', '2024-04-15', 'Acceptat', 'Entrevista confirmada.');
INSERT INTO enviament (codicv, CIFNIF_empresa, data_contacte, data_resposta, data_entrevista, estat, notes) VALUES
...
INSERT INTO enviament (codicv, CIFNIF_empresa, data_contacte, data_resposta, data_entrevista, estat, notes) VALUES
(007884881, 'Q45678901', '2024-04-17', '2024-04-21', '2024-04-26', 'Rebutjat', 'No va assistir a l’entrevista.');
INSERT INTO enviament (codicv, CIFNIF_empresa, data_contacte, data_resposta, data_entrevista, estat, notes) VALUES
...
INSERT INTO enviament (codicv, CIFNIF_empresa, data_contacte, data_resposta, data_entrevista, estat, notes) VALUES
(329316881, 'Y23456789', '2024-04-25', '2024-04-29', '2024-05-04', 'En procés', 'Segona ronda d’entrevistes.');
INSERT INTO enviament (codicv, CIFNIF_empresa, data_contacte, data_resposta, data_entrevista, estat, notes) VALUES
(329316881, 'A13725999', '2024-04-26', '2024-04-30', '2024-05-05', 'Rebutjat', 'No va assistir a l’entrevista.');
INSERT INTO A13725999 (codicv, CIFNIF_empresa, data_contacte, data_resposta, data_entrevista, estat, notes) VALUES
(329316881, 'A45678901', '2024-04-27', '2024-05-01', '2024-05-06', 'Acceptat', 'Oferta de feina enviada.');
INSERT INTO enviament (codicv, CIFNIF_empresa, data_contacte, data_resposta, data_entrevista, estat, notes) VALUES
...
('85536542W', 'H14056188', '2024-05-01', '2024-08-31', '9:00-17:00', 'Laura Gomez', 'En proces', 'Intensiva', 'Desenvolupament web');
INSERT INTO assignacio (DNI_alumne, CIFNIF_empresa, data_inici, data_fi, horari, tutor, estat, tipus, especialitzacio) VALUES
('55972173V', 'B12345678', '2024-05-05', '2024-09-05', '10:00-18:00', 'Carlos Ruiz', 'Finalitzat', 'General', 'Administració de sistemes');
INSERT INTO assignacio (DNI_alumne, CIFNIF_empresa, data_inici, data_fi, horari, tutor, estat, tipus, especialitzacio) VALUES
('58650705S', 'C87654321', '2024-06-01', '2024-09-30', '8:00-16:00', 'Ana Martinez', 'En proces', 'Intensiva', 'Seguretat informàtica');
INSERT INTO assignacio (DNI_alumne, CIFNIF_empresa, data_inici, data_fi, horari, tutor, estat, tipus, especialitzacio) VALUES
('86803051Q', 'D23456789', '2024-05-15', '2024-08-15', '9:00-17:00', 'Javier Lopez', 'Cancelada', 'General', 'Bases de dades');
INSERT INTO assignacio (DNI_alumne, CIFNIF_empresa, data_inici, data_fi, horari, tutor, estat, tipus, especialitzacio) VALUES
('89908640F', 'E98765432', '2024-06-10', '2024-10-10', '10:00-18:00', 'Sofia Hernandez', 'En proces', 'Intensiva', 'Administració de xarxes');
INSERT INTO assignacio (DNI_alumne, CIFNIF_empresa, data_inici, data_fi, horari, tutor, estat, tipus, especialitzacio) VALUES
('00788488W', 'F34567890', '2024-05-20', '2024-09-20', '8:00-16:00', 'Miguel Torres', 'Finalitzat', 'General', 'Virtualització');
INSERT INTO assignacio (DNI_alumne, CIFNIF_empresa, data_inici, data_fi, horari, tutor, estat, tipus, especialitzacio) VALUES
('53671343S', 'G45678901', '2024-06-05', '2024-10-05', '9:00-17:00', 'Isabel Ramirez', 'En proces', 'Intensiva', 'Desenvolupament  de aplicacions');
INSERT INTO assignacio (DNI_alumne, CIFNIF_empresa, data_inici, data_fi, horari, tutor, estat, tipus, especialitzacio) VALUES
('32931688N', 'H56789012', '2024-05-25', '2024-09-25', '10:00-18:00', 'Fernando Jimenez', 'Cancelada', 'General', 'Administració de sistemes');